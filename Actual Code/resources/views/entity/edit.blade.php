    ...
    <div class="card shadow">
        <div class="card-header border-0">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="mb-0">Editar Aseguradora</h3>
                </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ url('/entity/'.$entity->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="nit" class="form-control" value="{{ old('nit', $entity->nit) }}" required>
                </div>
                ...
                <button type="submit" class="btn btn-sm btn-primary ">Guardar Aseguradora</button>
            </form>
        </div>
